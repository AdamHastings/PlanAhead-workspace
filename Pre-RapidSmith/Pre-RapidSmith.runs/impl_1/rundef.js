...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc4vlx60ff668-10 -dd _ngo -uc \"system.ucf\" -sd /home/adam/RO-PUF/XPS-workspace/hw/implementation/ \"system.edf\"" );
ISEStep( "map",
         "-intstyle pa -w \"system.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"system.ncd\" -w \"system_routed.ncd\"" );
ISEStep( "trce",
         "-intstyle ise -o \"system.twr\" -v 30 -l 30 \"system_routed.ncd\" \"system.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"system_routed.ncd\" \"system_routed.xdl\"" );
